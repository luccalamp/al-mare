              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="overflow-hidden rounded-[22px] border border-[var(--color-brand-line)] bg-[var(--color-brand-soft)]">
                  ...
                  <div className="relative aspect-[4/5] w-full">
                    <Image src={pair.before.url} alt="Foto antes" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" unoptimized />
                  </div>
                </div>
                ...
                <div className="overflow-hidden rounded-[22px] border border-[var(--color-brand-line)] bg-[var(--color-brand-soft)]">
                  ...
                  <div className="relative aspect-[4/5] w-full">
                    <Image src={pair.after.url} alt="Foto depois" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" unoptimized />
                  </div>
                </div>
              </div>
            </article>
